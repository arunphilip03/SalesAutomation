...
private boolean setContact = false;
    ...
    public List attributeListForIteratorContacts() {
        ...
        DCIteratorBinding iter = bc.findIteratorBinding("ContactAppInviteeVO2Iterator");
    ...
    public void setSourceContactId() {
        
        if(!setContact) {
            setContact =  true;
        DCBindingContainer bc = (DCBindingContainer) getBindings();
        DCIteratorBinding iterBind = (DCIteratorBinding) bc.get("ContactAppointmentsVO1Iterator");
        BigDecimal contactIdRow = (BigDecimal) iterBind.getCurrentRow().getAttribute("ContactId");
        
        System.out.println("Contact Id from current row "+contactIdRow);
    ...
    public void onCommit(ActionEvent actionEvent) {
        ...
        DCIteratorBinding iter1 = bc.findIteratorBinding("ContactAppointmentsVO1Iterator");
        DCIteratorBinding iter = bc.findIteratorBinding("ContactAppInviteeVO2Iterator");
