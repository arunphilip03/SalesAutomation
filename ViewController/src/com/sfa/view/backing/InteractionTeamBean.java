...
public class InteractionTeamBean {
    public InteractionTeamBean() {
        super();
    }
    ...
    public List attributeListForIteratorContacts() {
        ...
        DCIteratorBinding iter = bc.findIteratorBinding("ContactInteractionTeamVO1Iterator");
        if(iter == null) {
...
//        }
    ...
    public BigDecimal getCurrentInteractionId() {
        ...
        DCIteratorBinding iterBind = (DCIteratorBinding) bc.get("ContactInteractionsVO1Iterator");
        BigDecimal appId = (BigDecimal) iterBind.getCurrentRow().getAttribute("InteractionId");
    ...
    public void onCommit(ActionEvent actionEvent) {
        ...
        if (size > 0) {
            for (int i = 0; i < size; i++) {
                ...
                row.setAttribute("InteractionId", getCurrentInteractionId());
